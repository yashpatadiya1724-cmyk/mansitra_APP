            ...
            <div className="bg-white p-8 sm:p-10 rounded-[40px] border border-slate-200 shadow-lg flex flex-col justify-between">
              ...
              <div>
                <div className="flex gap-4">
                  ...
                  <a href="https://www.instagram.com/yash_patadiya_1724?igsh=bjJzZTVrZzBxcTh5" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#e1306c] hover:bg-[#d82d64] text-white font-bold px-4 py-2 rounded-full text-xs transition-colors shadow-sm">
                    <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

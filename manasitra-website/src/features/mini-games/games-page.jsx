...
import { Wind, Hand, Grid3x3, Anchor, Palette, Sparkles, Type, Flower2, ScanLine, Package, Gamepad2, Zap, ArrowLeft } from 'lucide-react'
import { useMoodStore } from '@store/mood-store'
import { useProgressStore } from '@store/progress-store'
import { useGardenStore, XP_REWARDS } from '@store/garden-store'

const GAMES = [
  { key:'breathing',    route:'/chat/games/breathing',    icon:Wind,     color:'#62C8B9', duration:'~2 min',  tag:'Breathing' },
  { key:'tap',          route:'/chat/games/tap',          icon:Hand,     color:'#9B8FF0', duration:'~1 min',  tag:'Release' },
  { key:'grounding',    route:'/chat/games/grounding',    icon:Anchor,   color:'#5DD6A0', duration:'~3 min',  tag:'Grounding' },
  { key:'puzzle',       route:'/chat/games/puzzle',       icon:Grid3x3,  color:'#F0B860', duration:'~2 min',  tag:'Focus' },
  { key:'canvas',       route:'/chat/games/canvas',       icon:Palette,  color:'#E87090', duration:'Open',    tag:'Express' },
  { key:'affirmations', route:'/chat/games/affirmations', icon:Sparkles, color:'#9B8FF0', duration:'~1 min',  tag:'Uplift' },
  { key:'word_reset',   route:'/chat/games/word_reset',   icon:Type,     color:'#62C8B9', duration:'~2 min',  tag:'Reflect' },
  { key:'gratitude',    route:'/chat/games/gratitude',    icon:Flower2,  color:'#F5C842', duration:'~3 min',  tag:'Gratitude' },
  { key:'body_scan',    route:'/chat/games/body_scan',    icon:ScanLine, color:'#5B9BD5', duration:'~4 min',  tag:'Body' },
  { key:'worry_box',    route:'/chat/games/worry_box',    icon:Package,  color:'#E87090', duration:'~3 min',  tag:'Release' },
]
      ...
      <div className="page-wrap">
        ...
        <div style={{ marginBottom: 28 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
            <button onClick={() => router.back()} className="p-2 -ml-2 rounded-full hover:bg-neutral-100 text-neutral-600 transition-colors">
              <ArrowLeft size={20} />
            </button>
